...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-30 flex items-center justify-around border-t border-white/10 bg-zinc-900/95 px-2 py-2 backdrop-blur-md md:hidden"
